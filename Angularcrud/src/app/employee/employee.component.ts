...
export class EmployeeComponent implements OnInit {  
  ...
  constructor(private formbulider: FormBuilder, private employeeService:EmployeeService, private currencyPipe:CurrencyPipe) { 
    this.sSoldi = this.currencyPipe.transform('100');
  }  
